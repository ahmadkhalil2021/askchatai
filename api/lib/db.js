...
export async function initDB() {
  ...
  await sql`CREATE TABLE IF NOT EXISTS chats (id TEXT PRIMARY KEY, user_id INTEGER REFERENCES users(id) ON DELETE CASCADE, name TEXT NOT NULL DEFAULT 'Chat', model TEXT NOT NULL, messages JSONB DEFAULT '[]', created_at TIMESTAMP DEFAULT NOW())`;
